  ...
  for (let show of shows) {
    const $show = $(
      `<div data-show-id="${show.id}" class="Show col-md-12 col-lg-6 mb-4">
         <div class="media">
         <img src="${show.image}" class="align-self-center me-3">
...
/** Given an array of episodes info, populate them into the #episodes-list part of the DOM */

function populateEpisodes(episodes) {
  const $episodesList = $("#episodesList");
  const $episodesArea = $("#episodesArea");
  const $backToShowList = $("#backToShowList");
  ...
  $("#backToShowList").on("click", function () {
    $("#showsList").show();
    $("#episodesArea").hide();
  });
...
// Event handler for the "Episodes" button
